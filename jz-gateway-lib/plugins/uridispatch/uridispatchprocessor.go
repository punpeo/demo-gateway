...
import (
	...
	"gitlab.jianzhikeji.com/jz-backend/go-lib/rest/restyclient"
	"gitlab.jianzhikeji.com/jz-backend/go-lib/rest/result"
	"gitlab.jianzhikeji.com/jz-backend/go-lib/rest/xerr"
	"io/ioutil"
	"net"
	"net/http"
	"net/url"
